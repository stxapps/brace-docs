...
export const metadata = {
  title: 'Docs',
  description: 'Welcome to the Brace.to documentation. Find everything you need, whether to get started, master Brace.to, or troubleshoot here.',
};

Welcome to the Brace.to documentation. Find everything you need, whether to get started, master Brace.to, or troubleshoot here.
