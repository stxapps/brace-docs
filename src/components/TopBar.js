...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-50 flex flex-none flex-wrap items-center justify-between h-14 bg-white dark:bg-gray-900">
      ...
      <div className="mr-4 sm:mr-6 lg:mr-8 xl:mr-12 relative flex basis-0 justify-end md:grow">
        <ThemeSelector className="relative z-10" />
        <Link className="ml-2.5 md:ml-0 group block h-14 flex items-center justify-center focus:outline-none" href="https://brace.to" aria-label="Brace.to" target="_blank" rel="noreferrer">
          <div className="flex items-center rounded-full border border-gray-400 bg-white px-2.5 py-1.5 text-sm text-gray-500 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300 group-hover:border-gray-500 group-focus-visible:ring dark:border-gray-500 dark:bg-gray-900 dark:group-hover:border-gray-400">
      ...
      {isScrolled && (
        <>
          ...
          <div className="absolute bottom-0 left-16 right-16 h-px bg-gray-200 dark:bg-gray-700" />
