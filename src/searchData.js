export const searchData = [
  {
    'path': '/',
    'title': "Welcome to Brace.to's documentation",
    'sections': [
      [
        '',
        '',
